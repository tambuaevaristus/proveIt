...
export default function UserSidebar({ isNavOpen }: any) {
          ...
          <div className="pb-4 text-gray-500 ">
            ...
            <ul className="mt-10">
              ...
              <li className="relative px-6 py-3">
                ...
                >
                  <FaCamera size={20} />
                  <span className="ml-4 text-[15px]">My Teams</span>
                </Link>
              </li>
              <li className="relative px-6 py-3">
                <a
                ...
                >
                  ...
                  >
                    ...
                    <span className="ml-4 text-[15px]">Teams Projects</span>
                  </Link>
                </a>
              </li>
              <li className="relative px-6 py-3">
                ...
                >
                  ...
                  >
                    <BsCreditCard2Front size={20} />
                    <span className="ml-4 text-[15px]">Time sheet</span>
                  </Link>
                </a>
              </li>
              <li className="relative px-6 py-3">
